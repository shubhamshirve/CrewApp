...
def generate_contract_pdf(
    ...
    doc = SimpleDocTemplate(
        ...
        topMargin=2 * cm,
        bottomMargin=2 * cm,
        title=f"CrewBook Contract – {gig.get('title', 'Gig')}",
    )
    ...
    # ── Header ────────────────────────────────────────────────────────────────
    story.append(Paragraph("CrewBook", title_style))
    ...
    terms = [
        ...
        "2. <b>Cancellation:</b> Either party must notify the other at least 48 hours before the first session. Late cancellations may attract a penalty as per CrewBook policy.",
        ...
        "4. <b>Conduct:</b> Both parties agree to maintain professional conduct and adhere to CrewBook's community guidelines.",
        "5. <b>Confidentiality:</b> Client details, shoot locations, and any personal information shared are strictly confidential.",
        "6. <b>Dispute Resolution:</b> Any disputes will be resolved via CrewBook's arbitration process.",
        "7. <b>Platform:</b> This contract is facilitated by CrewBook (crewbook.in) and is subject to platform terms of service.",
    ]
    for t in terms:
    ...
    story.append(Paragraph(
        "This document was auto-generated by CrewBook · crewbook.in · Not a legally binding document without physical signatures.",
