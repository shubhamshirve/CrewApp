...
def generate_contract_pdf(
    ...
    terms = [
        ...
        "7. <b>Platform:</b> This contract is facilitated by Photoo (app.photoo.in) and is subject to platform terms of service.",
    ]
    for t in terms:
    ...
    story.append(Paragraph(
        "This document was auto-generated by Photoo · app.photoo.in · Not a legally binding document without physical signatures.",
